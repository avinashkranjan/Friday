    ...
    return SafeArea(
      ...
      pages: [
        ...
        PageViewModel(
            ...
            body:
                'Track your work progress, get timely alerts about your submissions, and much more.',
            image: Center(
              child: Image.asset(
        ...
        PageViewModel(
            ...
            body:
                'Be organized in class or workspace, and never miss an important deadline.',
            image: Center(
              child: Image.asset(
            ...
            child: Center(
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                    elevation: 10, backgroundColor: Colors.deepPurple),
                onPressed: () async {
